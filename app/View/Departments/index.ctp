<div class="departments index">
	...
	<tr>
		...
		<td><?php echo h($department['Department']['name_en']); ?>&nbsp;</td>
		<td><?php echo h($department['Department']['parent']); ?>&nbsp;</td>
		<td><?php echo h($department['Department']['level']); ?>&nbsp;</td>
		<td><?php echo h($department['Department']['sort']); ?>&nbsp;</td>
		<td><?php echo h($department['Department']['total_child']); ?>&nbsp;</td>
		<td><?php echo h($department['Department']['enable']); ?>&nbsp;</td>
		<td><?php echo h($department['Department']['created']); ?>&nbsp;</td>
		<td><?php echo h($department['Department']['modified']); ?>&nbsp;</td>
		<td><?php echo h($department['Department']['_create_uid']); ?>&nbsp;</td>
		<td><?php echo h($department['Department']['_update_uid']); ?>&nbsp;</td>
		<td><?php echo h($department['Department']['_version']); ?>&nbsp;</td>
		<td class="actions">
