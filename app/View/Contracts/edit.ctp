...
<div class="content-body">
    <?php 
        ...
        echo " <span id='productSelected'><strong>Product: </strong> {$this->data['Product']['name']}  <strong>Serial: </strong> {$this->data['Serial']['serial_no']}</span>";
        echo '</div>';
        echo '<div class="form-group">';
		...
		echo " <span id='customerSelected'>{$this->data['Customer']['name']} {$this->data['CustomerLocation']['branch_name']} {$this->data['CustomerLocation']['zone_name']}</span>";
        echo '</div>';
